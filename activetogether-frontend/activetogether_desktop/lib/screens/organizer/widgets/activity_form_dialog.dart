...
class ActivityFormDialog extends StatefulWidget {
  final ActivityListItem? existing;

  const ActivityFormDialog({super.key, this.existing});
...
class _ActivityFormDialogState extends State<ActivityFormDialog> {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      title: Text(_isEditing ? 'Uređivanje aktivnosti' : 'Nova aktivnost'),
      content: SizedBox(
        width: 460,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      DropdownButtonFormField<int>(
                        ...
                        hint: const Text('Odaberite vrstu'),
                        items: [
                      ...
                      TextFormField(
                        ...
                        validator: (v) {
                          ...
                          if (_isEditing &&
                              n < widget.existing!.reservedCount) {
                            return 'Kapacitet ne može biti manji od broja prijavljenih (${widget.existing!.reservedCount}).';
                          }
                          return null;
                        },
                      ),
